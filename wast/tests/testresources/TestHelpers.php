...
{
    $filename = \Wast\ESAPI::getSecurityConfiguration()->getLogFileName();
...
function getRandomAlphaNumString($len)
{
    ...
    \Wast\ESAPI::getEncoder();
    return \Wast\ESAPI::getRandomizer()->getRandomString(
        $len,
        \Wast\Encoder::CHAR_ALPHANUMERICS
    );
}
