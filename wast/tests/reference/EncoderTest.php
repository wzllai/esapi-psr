...
use \Wast\Codecs\JavaScriptCodec;
use \Wast\Codecs\CssCodec;
use \Wast\Codecs\MySQLCodec;
use \Wast\Codecs\OracleCodec;
use \Wast\Codecs\UnixCodec;
use \Wast\Codecs\WindowsCodec;
use \Wast\Codecs\HTMLEntityCodec;
use \Wast\Codecs\PercentCodec;
use \Wast\Auditor;
use \Wast\Encoder;
use \Wast\Codecs\Codec;
...
class EncoderTest extends PHPUnit_Framework_TestCase
{
    ...
    function testCanonicalize_101() {
        $this->assertEquals( '\v', $this->encoderInstance->canonicalize("\\v"));
    }
    function testCanonicalize_102() {
        $this->assertEquals( '\f', $this->encoderInstance->canonicalize("\\f"));
    }
