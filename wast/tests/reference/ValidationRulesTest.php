...
use \Wast\ESAPI;
use \Wast\Reference\Validation\CreditCardValidationRule;
use \Wast\Reference\Validation\DateValidationRule;
use \Wast\Reference\Validation\HTMLValidationRule;
use \Wast\Reference\Validation\IntegerValidationRule;
use \Wast\Reference\Validation\NumberValidationRule;
use \Wast\Reference\Validation\StringValidationRule;
use \Wast\Reference\DefaultEncoder;
use \Wast\Codecs\Base64Codec;
...
class ValidationRulesTest extends PHPUnit_Framework_TestCase
{
    ...
    function testStringVR_assertValid_invalid()
    {
        ...
        $this->setExpectedException('\Wast\Errors\ValidationException');
    ...
    function testStringVR_assertValid_attack()
    {
        ...
        $this->setExpectedException('\Wast\Errors\IntrusionException');
    ...
    function testCCVR_constructValidator()
    {
        ...
        $this->assertTrue($ccvr->isValid('testCCVR_constructValidator', '0000-0000-0000-0000'));
    }
    ...
    function testCCVR_getValid_Empty()
    {
        ...
        $this->assertFalse($ccvr->isValid('testCCVR_getValid_Empty', '0'));
