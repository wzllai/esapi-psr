...
use \Wast\Errors\AuthenticationException;
use \Wast\Errors\ValidationException;
use \Wast\Errors\IntrusionException;
use \Wast\Errors\AuthenticationAccountsException;
use \Wast\Errors\AuthenticationCredentialsException;
use \Wast\Errors\AuthenticationHostException;
use \Wast\Errors\AuthenticationLoginException;
use \Wast\Errors\AvailabilityException;
use \Wast\Errors\CertificateException;
use \Wast\Errors\EncodingException;
use \Wast\Errors\EncryptionException;
use \Wast\Errors\ExecutorException;
use \Wast\Errors\IntegrityException;
use \Wast\Errors\ValidationAvailabilityException;
use \Wast\Errors\ValidationUploadException;
