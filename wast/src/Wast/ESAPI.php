...
use \Wast\Reference\FileBasedAccessController;
use \Wast\Reference\DefaultEncoder;
use \Wast\Reference\DefaultExecutor;
use \Wast\Reference\DefaultHTTPUtilities;
use \Wast\Reference\DefaultIntrusionDetector;
use \Wast\Reference\DefaultAuditorFactory;
use \Wast\Reference\DefaultRandomizer;
use \Wast\Reference\DefaultSecurityConfiguration;
use \Wast\Reference\DefaultValidator;
use \Wast\Reference\DefaultSanitizer;
...
class ESAPI
{
    ...
    {
        if (!$path) {
            $path = dirname(__FILE__)."/../../tests/testresources/ESAPI.xml";
        }
